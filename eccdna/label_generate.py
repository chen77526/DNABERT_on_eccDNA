...
def mainf():
    with open ('./output/{}/label_{}.tsv'.format(args.data, args.length), 'w') as output_f1:
        with open ('./output/{}/label_{}_dev.tsv'.format(args.data, args.length), 'w') as output_f2:
            with open('./output/{}/{}_positive_{}_limit.fa.out'.format(args.data, args.gene, args.length), 'r') as input_f1:
                with open('./output/{}/{}_negative_{}_limit.fa.out'.format(args.data, args.gene, args.length), 'r') as input_f2:
